      ...
      <div class="profilo__centro">
        <div class="ods__form__buttons">
          <button @click="this.sezione__centrale = 0"
            ...
            visitati</button>
          <button @click="this.sezione__centrale = 1"
        ...
        <div class="container__post__inside" v-if="this.sezione__centrale == 1">
          <v-skeleton-loader v-if="files.length == 0" type="list-item-avatar"></v-skeleton-loader>
        ...
        getDownloadURL(refFire(storage, "posts/" + doccolo.data().utente__id + "/" + doccolo.id + "/immagine0"
          ...
          .then((url) => {
            if (url) {
              ...
              if (doccolo.data().utente__id == localStorage.getItem("login")) {
