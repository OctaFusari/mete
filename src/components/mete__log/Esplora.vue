<template>
    ...
    align-items: center;">
          <h2>Filtri</h2><a style="margin-left: 3vh;">Modifica</a>
        </div>
        <button class="buttonheavy__little">Party</button>
        <button class="buttonheavy__little">Cultura</button>
        <button class="buttonheavy__little">snorkeling</button>
      </div>
    </div>
    <div>
      
    </div>
    <div class="ods__carousel">
      <div class="ods__card">
        <div class="ods__card__inside">
          <div class="ods__card__inside__uno">
            <div>
              <img >
              <h3>Octavian Fusari</h3>
            </div>
            <h1>Corfù, Grecia</h1>
